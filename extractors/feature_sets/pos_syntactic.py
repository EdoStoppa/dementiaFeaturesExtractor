...
def get_all_syntactics_features(sample, base_folder=os.getcwd()):
    ...
    with open(sample_output_name, 'w+') as output:
        at.analyze_file(sample_file_name, output, calling_dir=SCA_FOLDER)
...
def get_all(interview, base_folder=os.getcwd()):
    feature_dict = get_all_syntactics_features(interview, base_folder)
